...
<Mcml xmlns="http://schemas.microsoft.com/2006/mcml"
      ...
      xmlns:btn="http://retrosight.com/samples/windowsmediacentersdk/6/ControlsButton.mcml">
    ...
    <Content>
      <Panel Layout="VerticalFlow">
        <Children>
          ...
          <btn:Button>
            <Command>
              <NavigateCommand Source="http://retrosight.com/samples/windowsmediacentersdk/6/WebCookiesGet.asp" Description="Get Cookies"/>
            </Command>
          </btn:Button>
        </Children>
      </Panel>
